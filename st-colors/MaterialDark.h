...
static const char *colorname[] = {
	...
	"#fee92e",		/* 11: ANSI Color 11 */
	"#53a4f3",		/* 12: ANSI Color 12 */
	"#a94dbb",		/* 13: ANSI Color 13 */
	"#26bad1",		/* 14: ANSI Color 14 */
	"#d8d8d8",		/* 15: ANSI Color 15 */
	[255] = 0,
	[256] = "#222221",		/* 256: Background */
	[257] = "#e4e4e4",		/* 257: Foreground */
	[258] = "#16aec9",		/* 258: Cursor */
	[259] = "#dedede",		/* 259: Cursor Text */
	/* No support for text highlight coloring; would be #3d3d3d. */
	/* No support for highlight coloring; would be #dedede. */
	/* No support for bold coloring; would be #b7141e. */
};
