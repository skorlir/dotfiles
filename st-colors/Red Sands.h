...
static const char *colorname[] = {
	...
	"#ff3f00",		/* 1: ANSI Color 1 */
	"#00bb00",		/* 2: ANSI Color 2 */
	"#e7b000",		/* 3: ANSI Color 3 */
	"#0071ff",		/* 4: ANSI Color 4 */
	"#bb00bb",		/* 5: ANSI Color 5 */
	"#00bbbb",		/* 6: ANSI Color 6 */
	"#bbbbbb",		/* 7: ANSI Color 7 */
	"#555555",		/* 8: ANSI Color 8 */
	"#bb0000",		/* 9: ANSI Color 9 */
	"#00bb00",		/* 10: ANSI Color 10 */
	"#e7b000",		/* 11: ANSI Color 11 */
	"#0071ae",		/* 12: ANSI Color 12 */
	"#ff55ff",		/* 13: ANSI Color 13 */
	"#55ffff",		/* 14: ANSI Color 14 */
	"#ffffff",		/* 15: ANSI Color 15 */
	[255] = 0,
	[256] = "#79241e",		/* 256: Background */
	[257] = "#d7c9a7",		/* 257: Foreground */
	[258] = "#ffffff",		/* 258: Cursor */
	[259] = "#000000",		/* 259: Cursor Text */
	/* No support for text highlight coloring; would be #000000. */
	/* No support for highlight coloring; would be #a4a390. */
	/* No support for bold coloring; would be #dfbd22. */
};
